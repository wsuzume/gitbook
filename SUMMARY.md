...
* [2. 機械学習](mml/machine-learning/README.md)
  ...
  * [2.2. 回帰問題](mml/machine-learning/regression/README.md)
    ...
    * [線形基底関数モデル](mml/machine-learning/regression/moderu.md)
    * [カーネル回帰](mml/machine-learning/regression/kneru-2.md)
    * [確率論からの導出](mml/machine-learning/regression/from-probability.md)
    * [ガウス過程回帰](mml/machine-learning/regression/gausu.md)
