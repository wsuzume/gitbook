...
## 機械学習のための数学 <a id="math-for-ml"></a>

* [確率論](math-for-ml/probability-theory.md)

## 機械学習・データサイエンス <a id="mml"></a>

* [1. 機械学習・データサイエンス（概要）](mml/abstract.md)
* [2. 機械学習](mml/machine-learning/README.md)
  * [2.1. 機械学習をこれから始める人へ](mml/machine-learning/introduction.md)
  * [2.2. 回帰問題](mml/machine-learning/regression/README.md)
    ...
    * [2.2.3. 線形基底関数モデル](mml/machine-learning/regression/moderu/README.md)
      * [いろいろな基底関数](mml/machine-learning/regression/moderu/basis-functions.md)
    ...
    * [2.2.7. 一般化線形モデル](mml/machine-learning/regression/227-moderu.md)
    * [2.2.8. 一般化加法モデル](mml/machine-learning/regression/228-moderu.md)
    * [2.2.9. 分位点回帰](mml/machine-learning/regression/2.2.9.-fen-wei-dian-hui-gui.md)
    * [2.2.10. 3層ニューラルネットワーク](mml/machine-learning/regression/neural-network.md)
    * [2.2.11. 深層学習](mml/machine-learning/regression/2.2.8.-shen-ceng-xue-xi.md)
    * [2.2.12. 深層学習とガウス過程](mml/machine-learning/regression/229-togausu.md)
...
* [3. データサイエンス](mml/data-science/README.md)
  ...
  * [スパースモデリング](mml/data-science/sparse-modeling/README.md)
    * [LASSO](mml/data-science/sparse-modeling/lasso/README.md)
      * [FISTA](mml/data-science/sparse-modeling/lasso/fista.md)
      * [ADMM](mml/data-science/sparse-modeling/lasso/admm.md)
    * [全状態探索法](mml/data-science/sparse-modeling/quan-zhuang-tai-tan-suo-fa.md)
...
* [位相限定相関法](others/phase-only-correlate.md)
...
## なんかの部屋 <a id="something"></a>

* [データの表現について](something/about-data-representation.md)
